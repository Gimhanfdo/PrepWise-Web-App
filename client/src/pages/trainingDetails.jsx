...
//     console.log('Full Training Data:', trainingData); // Debug log

//     if (trainingData.success) {
//       setTraining(trainingData.data);
      
//       // Debug: Check what trainerId looks like
//       console.log('Raw trainerId:', trainingData.data.trainerId);
//       console.log('Type of trainerId:', typeof trainingData.data.trainerId);
      
//       // Handle different possible trainer ID formats
//       let trainerId = null;
...
//       // Try alternative field names if trainerId doesn't exist
//       if (!trainerId) {
...
//     const response = await fetch(`/api/trainer/${trainer._id}/review`, {
//       method: 'POST',
//       credentials: 'include',
//       headers: {
...
//         trainingId: id // Include training ID for context
//       })
//     });
...
//     if (data.success) {
//       // Update trainer state with new review
//       setTrainer(prev => ({
//         ...prev,
...
//                               placeholder="Share your thoughts about this training and trainer..."
...
//                         <p>No reviews yet</p>
//                         {!showReviewForm && (
//                           <p className="text-sm mt-2">Be the first to review this training!</p>
//                         )}
//                       </div>
//                     )}
//                   </div>
